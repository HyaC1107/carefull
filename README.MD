...
<table>
  <tr>
    <td align="center">
      <img src="main.png" height="300"/>
      <br/>
    </td>
    <td align="center">
      <img src="main2.png" height="300"/>
      >
    </td>
  </tr>
</table>
...
![Carefull_md_ohs architecture](시스템아키텍쳐.png)
...
![Carefull_md_ohs device](device.png)

### 보호자 대시보드

![Carefull_md_ohs Dashboard](dashboard.png)

### 복약 스케줄 관리

![Carefull_md_ohs Schedule](schedule.png)

### 복약 이력 및 알림

![Carefull_md_ohs Notification](notification.png)

### 지문 등록

![Carefull_md_ohs fp](fp.png)
...
| **오형석** | **Backend**         | API 설계, ElevenLabs TTS 시스템 구축, FCM 알림 로직 |
...
![Carefull_md_ohs ts1](ts1.png)

### 2. 복약 행위 검증 AI 모델링

![Carefull_md_ohs ts2](ts2.png)

### 3. 복약 일정 삭제 오류

![Carefull_md_ohs ts3](ts3.png)